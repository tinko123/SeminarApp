        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizerId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "The organizer of the seminar"),
                    DateAndTime = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "The date and time of the seminar"),
                    Duration = table.Column<int>(type: "int", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "The category of the seminar")
                },
                constraints: table =>
                {
